...
def _validate_rule_consistency(rule: Rule) -> None:
    ...
    for slot_name, slot_actions in (
        ...
        _validate_action_slot(slot_name, slot_actions)


def _validate_action_slot(slot_name: str, slot_actions: Iterable[RuleAction]) -> None:
    """Apply the same action policy to legacy rules and task boundary slots."""
