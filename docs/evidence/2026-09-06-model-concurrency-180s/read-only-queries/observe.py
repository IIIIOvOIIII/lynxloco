...
out = {
    ...
    'configured_timeout_seconds': cfg.get('model', {}).get('omni', {}).get('timeout',120),
...
out['successful_cycles_over_120s'] = sum((r['cycle_total_ms'] or 0) > 120000 for r in durations)
out['successful_http_over_120s'] = sum(v > 120000 for v in stages['http_ms'])
out['cameras'] = query(
