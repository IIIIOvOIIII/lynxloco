...
- [ ] Merge the 37 new upstream commits; resolve .gitignore by retaining both sets of rules. Review automatic merges around startup/shutdown, MIoT and packaging.
